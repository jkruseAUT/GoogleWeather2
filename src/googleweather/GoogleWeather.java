...
public class GoogleWeather {
	private XML weatherXML;
	private XML geocodeXML;
	...
	public String getWeekdayInXDays(int daysFromToday)
		...
		String weekdayToday;
		try {
			XML lower = weatherXML.getChild(0);
			temp = lower.getChild(2 + daysFromToday);
			XML tmp = temp.getChild(0);
	...
	public float getLongitude() throws ArrayIndexOutOfBoundsException {
		...
		try {
			XML status = geocodeXML.getChild(0);
